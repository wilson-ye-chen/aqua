#!/bin/bash
#
# Usage: sub_gjrskt_fore.sh key start end
# Purpose:
# Submit a batch of jobs for the empirical study of the GJR-Skt model
...
OUT=/project/symbolic/out/symbolic/fore_gjrskt/$key/gjrskt.$key.
PROJECT=symbolic
JOBNAME=$key.
WALLTIME=72:00:00
NCPUS=1
...
cmd="matlab -r \" \
    ...
    try, gjr_forejob_skt('$DAT', '$OUT$start-$end.mat', \
