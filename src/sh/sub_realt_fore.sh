#!/bin/bash
#
# Usage: sub_realt_fore.sh key start end
# Purpose:
# Submit a batch of jobs for the empirical study of the Real-t model
...
OUT=/project/symbolic/out/symbolic/fore_realt/$key/realt.$key.
PROJECT=symbolic
JOBNAME=$key.
WALLTIME=72:00:00
NCPUS=1
...
cmd="matlab -r \" \
    ...
    try, realgarch_forejob_t('$DAT', '$OUT$start-$end.mat', \
