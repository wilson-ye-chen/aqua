#!/bin/bash
#
# Usage: sub_realskt_fore.sh key start end
# Purpose:
# Submit a batch of jobs for the empirical study of the Real-Skt model
...
OUT=/project/symbolic/out/symbolic/fore_realskt/$key/realskt.$key.
PROJECT=symbolic
JOBNAME=$key.
WALLTIME=72:00:00
NCPUS=1
...
cmd="matlab -r \" \
    ...
    try, realgarch_forejob_skt('$DAT', '$OUT$start-$end.mat', \
