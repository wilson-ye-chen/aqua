function [Theta, Accept, mapc, ThetaAd, Scale] = aqua_est_tc( ...
    Xi, nIter, nDiscard)
% [Theta, Accept, mapc, ThetaAd, Scale] = aqua_est_tc(Xi, nIter, nDiscard)
% implements a Gibbs sampling scheme to generate samples from the posterior
% of the gh-AQUA model, where the dependencies are modelled using a t-copula,
% the conditional marginal distributions of a, log(b), and g are skewed-t,
% and those of h are Apatosaurus.
%
...
% Date:   February 23, 2017
    ...
    h0 = [0.1, 0.1, 0.8, 3, 0.01, 0.1, 8, 0, 0.001];
    c0 = nonzeros(tril(corr(Xi), -1))';
    df0 = 10;
    theta0 = [a0, b0, g0, h0, c0, df0];
