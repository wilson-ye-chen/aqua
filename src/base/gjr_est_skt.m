function [Theta, Accept, mapc, ThetaAd, Scale] = gjr_est_skt( ...
    r, nIter, nDiscard)
% [Theta, Accept, mapc, ThetaAd, Scale] = gjr_est_skt(r, nIter, nDiscard)
% implements an adaptive random walk Metropolis algorithm to generate samples
% from the posterior of the GJR-GARCH-skt model.
%
