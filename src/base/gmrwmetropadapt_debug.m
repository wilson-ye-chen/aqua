function [Chain, Scale, Sigma, Accept, mapc] = gmrwmetropadapt_debug( ...
    kernelfun, start0, block, scale0, Sigma0, w, s, ...
    targAcc, accTol, nTune, nIter, nDiscard, ...
    minAdapt, maxAdapt, mapcTol)
% [Chain, Scale, Sigma, Accept, mapc] = gmrwmetropadapt_debug(kernelfun, ...
...
% Date:   February 3, 2015
    ...
    while ~stop
        ...
        for j = 1:nBlock
            ...
            disp(['block: ', num2str(j), ' cond: ', num2str(cond(S))]);
        end
