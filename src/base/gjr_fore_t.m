function ...
    ...
    gjr_fore_t(D, r, nEst, intEst, iStart, iEnd)
% [DFore, var1, var5, score1, score5, Theta, AccRate, Mapc] = gjr_fore_t ...
% (D, r, nEst, intEst, iStart, iEnd) computes one-step-ahead Bayesian
% forecasts using the GJR-GARCH-t model.
%
% Input:
...
% Theta   - posterior mean of GJR-t parameters.
...
% Date:   November 20, 2015
    ...
    [Chain, Accept, pc] = gjr_est_t(rEst, nIter, nDisc);
    ...
    for i = 1:nFore
        ...
        sigmaSq0 = var(rFore);
        QAve = gjr_aveq_t(u, Chain, rFore, sigmaSq0);
        var1(i) = QAve(end, 1);
        var5(i) = QAve(end, 2);
