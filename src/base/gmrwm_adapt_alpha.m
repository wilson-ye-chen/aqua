function [Chain, Scale, Sigma, Accept, mapc] = gmrwm_adapt_alpha( ...
    kernelfun, start0, block, scale0, Sigma0, w, s, ...
    targAcc, accTol, nTune, nIter, nDiscard, ...
    minAdapt, maxAdapt, mapcTol)
% [Chain, Scale, Sigma, Accept, mapc] = gmrwm_adapt_alpha(kernelfun, ...
...
% Scale     - vector of tuned scales of the blocks.
...
% Date:   February 2, 2015
    ...
    while ~stop
        ...
        [Chain, Accept, Scale] = gmrwm_tune_alpha( ...
