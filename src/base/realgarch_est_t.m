function [Theta, Accept, mapc, ThetaAd, Scale] = realgarch_est_t( ...
    r, logX, nIter, nDiscard)
% [Theta, Accept, mapc, ThetaAd, Scale] = realgarch_est_t(r, logX, nIter, ...
% nDiscard) implements a Gibbs sampling scheme to generate samples from the
% posterior of the Realised-GARCH-t model. The prior is flat over most of the
% allowable parameter space with the exception of the DoF parameter of the t
% distribution, where it is proportional to one over the squared DoF.
%
