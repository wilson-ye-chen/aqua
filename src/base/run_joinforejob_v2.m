function run_joinforejob_v2(dir)
% run_joinforejob_v2(dir) generates joined result files from the individual
...
% Date:   April 25, 2018
    ...
    for i = 1:nKey
        subDir = [dir, '/', key{i}];
        [DFore, Q, var1, var5, score1, score5, Beta1, Beta5, Mn, Sd, w, ...
            Theta, AccRate, Mapc] = aqua_joinforejob_v2(subDir);
        name = ['aqua.', key{i}, '.3051-', last{i}, '.mat'];
        save(name, ...
            'DFore', 'Q', 'var1', 'var5', 'score1', 'score5', ...
            'Beta1', 'Beta5', 'Mn', 'Sd', 'w', 'Theta', 'AccRate', 'Mapc');
